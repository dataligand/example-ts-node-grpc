...
export abstract class UnimplementedEchoService {
    static definition = {
        echo: {
            path: "/Echo/echo",
            requestStream: false,
    ...
    abstract echo(call: grpc_1.ServerUnaryCall<Query, Response>, callback: grpc_1.sendUnaryData<Response>): void;
}
export class EchoClient extends grpc_1.makeGenericClientConstructor(UnimplementedEchoService.definition, "Echo", {}) {
    constructor(address: string, credentials: grpc_1.ChannelCredentials, options?: Partial<grpc_1.ChannelOptions>) {
        super(address, credentials, options);
    }
    echo: GrpcUnaryServiceInterface<Query, Response> = (message: Query, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<Response>, options?: grpc_1.CallOptions | grpc_1.requestCallback<Response>, callback?: grpc_1.requestCallback<Response>): grpc_1.ClientUnaryCall => {
